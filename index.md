...
![](reference/figures/example2-1.png)
...
![](reference/figures/example3-1.png)
...
![](reference/figures/preview3-1.png)
...
- [`harlem_palette()`](http://www.shauritahutchins.com/harlem/reference/harlem_palette.md):
  A function to generate palettes with options for discrete or
  continuous output
- [`print_palette()`](http://www.shauritahutchins.com/harlem/reference/print_palette.md):
